...
export default function AddCategory() {
    ...
    const handleSubmit = async (e) => {
        ...
        await Axios.post('http://localhost:3001/products/category', json, {
            headers: {
    ...
    const handleDelete = async (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                await axios.delete(`http://localhost:3001/products/category/${valor}`)
                    .then(async () => {
                        await axios.get('http://localhost:3001/products/category')
                            .then(res => {
                                dispatch(getCategories(res.data));
    ...
    const handleEdit = async (e) => {
        ...
        await axios.get(`http://localhost:3001/products/category/cat/${pruebina[1]}`)
            .then(res => {
