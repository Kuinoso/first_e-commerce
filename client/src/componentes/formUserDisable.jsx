...
import { getToken, getDbCart, logOut, getUserInfo, getActiveOrder, resetCart } from '../Redux/Actions/actions'
    ...
    const submit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                await axios.post(`http://localhost:3001/user/${params.id}/motivo/baja`, json, {
                    headers: {
                        'content-type': 'application/json'
                    }
                })
                    .then(async (user) => {
                        await axios.put(`http://localhost:3001/user/${params.id}/baja`)
                            .then(() => {
